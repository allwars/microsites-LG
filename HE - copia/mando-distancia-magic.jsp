          ...
          <div class="fluid container" id="content">
            ...
            <div class="container">
              <div class="row mb-5">
                <div class="col">
                  <img
                    src="/es/mp-resources/images/posventa/microsites/television/mando-distancia-magic/image1.png"
              ...
              <div class="row mb-5">
                <div class="col">
                  <p>
                    Si quieres conocer los diferentes modelos de mando a
                    distancia Magic
                    <a
                      href="https://www.lg.com/es/posventa/microsites/television/magic-control-modelos"
                    >
                      pincha aquí</a
                    >
                  </p>
              ...
              <h2>
                ¿Cómo vincular el mando a distancia a la televisión?
              </h2>
              <div class="row mb-5">
                <div class="col">
                  <p>
                    Si quieres conocer cómo vincular el mando a distancia a la
                    televisión
                    <a
                      href="https://www.lg.com/es/posventa/guias-y-soluciones/television/vincular-magic-control-webos-new"
                    >
                      pincha aquí</a
                    >
                  </p>
                  <p>También puedes ver este video:</p>
                  <iframe
                    width="560"
                    height="315"
                    src="https://www.youtube.com/embed/cTbslC3cVKo"
              ...
              <h2>
                Consejos para el mando a distancia Magic
              </h2>
              <div class="row mb-5">
                <div class="col">
                  <p>
                    Si quieres conocer consejos del mando a distancia Magic
                    <a
                      href="https://www.lg.com/es/posventa/microsites/television/consejos-magic-control"
                    >
                      pincha aquí</a
                    >
                  </p>
