					...
					<div class="container">
                        ...
                        <div class="row mb-5">
                            <div class="col">
                                ...
                                <img src="/es/mp-resources/images/posventa//microsites/lavado-secado/carga-max-lavadora/1.jpg" class="img-fluid w-50 mx-auto d-block"
                                    alt="..."> 
                            </div>
                        </div>
                        ...
                        <div class="row mb-5">
                            <div class="col">
                                ...
                                <img src="/es/mp-resources/images/posventa//microsites/lavado-secado/carga-max-lavadora/2.jpg" class="img-fluid w-25 mx-auto d-block"
                                    alt="...">
                                ...
                                <img src="/es/mp-resources/images/posventa//microsites/lavado-secado/carga-max-lavadora/3.jpg" class="img-fluid w-25 mx-auto d-block"
                                    alt="...">
                                ...
                                <img src="/es/mp-resources/images/posventa//microsites/lavado-secado/carga-max-lavadora/4.png" class="img-fluid w-50 mx-auto d-block"
                                    alt="...">
                                    <img src="/es/mp-resources/images/posventa//microsites/lavado-secado/carga-max-lavadora/5.PNG" class="img-fluid w-50 mx-auto d-block"
                                    alt="...">
                                    <p>Cuando se muestre Dispositivo está listo ya podremos acceder a nuestro móvil desde el ordenador</p>
                                    <img src="/es/mp-resources/images/posventa//microsites/lavado-secado/carga-max-lavadora/6.PNG" class="img-fluid w-50 mx-auto d-block"
                                        alt="...">
                            </div>
                        </div>
                        ...
                        <div class="row mb-5">
                            <div class="col">
                                ...
                                <img src="/es/mp-resources/images/posventa//microsites/lavado-secado/carga-max-lavadora/7.png" class="img-fluid w-50 mx-auto d-block"
                                    alt="..."> 
                                <p>2.  Ya dentro de las opciones de Este equipo, seleccionamos nuestro terminal móvil, en este caso LG Velvet</p>
                                <img src="/es/mp-resources/images/posventa//microsites/lavado-secado/carga-max-lavadora/8.PNG" class="img-fluid w-50 mx-auto d-block"
                                    alt="..."> 
                                ...
                                <img src="/es/mp-resources/images/posventa//microsites/lavado-secado/carga-max-lavadora/9.PNG" class="img-fluid w-50 mx-auto d-block"
                                    alt="..."> 
                                ...
                                <img src="/es/mp-resources/images/posventa//microsites/lavado-secado/carga-max-lavadora/10.PNG" class="img-fluid w-50 mx-auto d-block"
                                    alt="..."> 
                            </div>
                        </div>
                    </div>
